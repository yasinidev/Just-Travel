		...
		<nav class="colorlib-nav" role="navigation">
			<div class="top-menu">
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-2">
							<div id="colorlib-logo"><a href="admin1.php" style="font-size: 27px;">Just Travel Agency</a></div>
						</div>
						<div class="col-xs-10 text-right menu-1">
							<ul>
								<li><a href="admin1.php" style="font-size: 27px;">Tour Requests</a></li>
								<li class="active"><a href="admin2.php" style="font-size: 27px;">Hotel Requests</a></li>
